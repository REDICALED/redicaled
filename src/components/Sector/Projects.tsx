    ...
    return (
        ...
        <ProjectCard 
            ...
            <p> 
                ...
                일반인에게 다소 낯선 Shell 환경에서의 전시 참여 방식 구현<br />
                </p>
            }
            stack={["Linux", "C", "Web Art"]}
            lastline={false}
            />
            <span className=" peer italic font-semibold underline ">작품 설명</span> <br/>
                <span className=" peer-hover:h-20  transition-all duration-500 peer-hover:opacity-100 opacity-0  ">
                ...
                하나의 문자에서 기인한 두 개의 공간은 실재하는 듯 실재하지 않거나, 실재하지만 그 연결고리는 모호한 별개의 공간이다. 이 만남은 어울리는 듯 어긋나며 눈앞의 놓인 공간이 결국 어디인지 헷갈리게만 만든다. 이렇듯 혼란한 위치 감각은 웹에서 느끼는 어렴풋한 공간감과 연결된다. 공간은 있지만 위치는 없는, 명확한 경로도 없는 공허한 어딘가를 감각해 보려 했다.</span>
